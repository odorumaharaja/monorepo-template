...
User-facing REST API built with [FastAPI](https://fastapi.tiangolo.com/) and Python 3.12.
...
- API is accessible at: `http://localhost:8000/api/user/`
- Swagger UI: `http://localhost:8000/api/user/docs`
- The `root_path` is set to `/api/user` for correct OpenAPI doc generation behind Nginx

## API Endpoints

| Method | Path | Description |
|---|---|---|
| `GET` | `/` | Root endpoint (returns `{"Hello": "User"}`) |
